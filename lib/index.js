 ...
 * and [benchmarks](http://dolphm.com/benchmarking-openstack-keystone-token-formats/).
 * It should be noted that the payload of a Fernet token as used within
 * OpenStack is serialized using MessagePack.
 *
 * Further relevant information about the nature of Fernet tokens, as used within
