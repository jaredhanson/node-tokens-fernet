...
module.exports = function(options, keying) {
  ...
  return function fernet_seal(claims, audience, options, cb) {
    if (typeof options == 'function') {
      cb = options;
      options = undefined;
    }
    ...
    keying(audience[0], query, function(err, encryptionKeys) {
      ...
      keying(audience[0], query, function(err, signingKey) {
        if (err) { return cb(err); }
